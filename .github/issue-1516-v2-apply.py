...
old_comment = '''    // Tapu Lele-GX: https://api.pokemontcg.io/v2/cards/sm2-60
...
'''
new_comment = '''    // Tapu Lele-GX: https://api.pokemontcg.io/v2/cards/sm2-60
    // Crispin: https://api.pokemontcg.io/v2/cards/sv7-133
    // Gladion: https://api.pokemontcg.io/v2/cards/sm4-95
...
tests = '''#define REGIDRAGO_SIM_NO_MAIN
