...
## Cleanup wave 2026-08-14 registry-contract ownership

- Compile-time bridge assertions for migrated exact-print ids, canonical print ids, and display names now live with `kRegisteredCardDefinitions` in `src/cards/card_registry.hpp`. `src/trace_engine_v2/core/card_catalog.inc` no longer owns a duplicate registry-invariant block. Registry owner: https://github.com/FlareZ123/pokemon-sims/blob/main/src/cards/card_registry.hpp
- Current bridge coverage includes Quick Ball, Guzma & Hala, Arven, Crispin, Dawn, and Powerglass. Exact card sources: https://api.pokemontcg.io/v2/cards/swsh1-179 https://api.pokemontcg.io/v2/cards/sm12-229 https://api.pokemontcg.io/v2/cards/sv1-166 https://api.pokemontcg.io/v2/cards/sv7-133 https://api.pokemontcg.io/v2/cards/me2-87 https://api.pokemontcg.io/v2/cards/sv6pt5-63
- Future migrations should place bridge assertions beside registry metadata when a compatibility invariant is still required. Printed resolution, route admission, DCI/UDP/AMR, connector domination, K0/K1, and matchup policy stay with their existing owners until a separately validated resolver migration proves the live state-transition boundary.
