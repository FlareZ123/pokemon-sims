...
The #3202 late Steven/VSTAR/Vessel route now delegates held-hand Dragon membership to `payload_zone_contains(state_.hand)`, and the shared #3458/#1797 connector delegates known-deck Dragon membership to `payload_zone_contains(state_.deck)`. These are membership-only migrations, so DCI/JIT timing, supporter contention, K1 admission, target preference, and route priority remain at the existing route owner. Route owner: https://github.com/FlareZ123/pokemon-sims/blob/main/src/trace_engine_v2/core/routes/steven_vstar_vessel_route_policy.inc Canonical payload owner: https://github.com/FlareZ123/pokemon-sims/blob/main/src/trace_engine_v2/core/payload_hand_policy.inc Regidrago VSTAR / Apex Dragon: https://api.pokemontcg.io/v2/cards/swsh12-136
