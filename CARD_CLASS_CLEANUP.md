...
The issue-3197 Steven/Mysterious Treasure/Crispin semantic route now has a canonical owner at `src/trace_engine_v2/core/routes/steven_treasure_crispin_semantic_policy.inc`. The historical root `part_issue_3197_steven_treasure_crispin_semantic_override.inc` remains as a compatibility include at the identical composition boundary. The complete function body, K1/JIT checks, projected Item-lock policy, and direct source documentation now live together under `core/routes/`. This is a textual ownership move only; route predicates, declaration order, macro lifetime, and gameplay behavior are unchanged. Steven's Resolve: https://api.pokemontcg.io/v2/cards/sm7-145 Mysterious Treasure: https://api.pokemontcg.io/v2/cards/sm6-113 Crispin: https://api.pokemontcg.io/v2/cards/sv7-133 Regidrago VSTAR: https://api.pokemontcg.io/v2/cards/swsh12-136 Advanced procedure: https://github.com/FlareZ123/pokemon-sims/blob/main/EN_advanced_manual-2025-transcription-structured.md Canonical owner: https://github.com/FlareZ123/pokemon-sims/blob/main/src/trace_engine_v2/core/routes/steven_treasure_crispin_semantic_policy.inc
