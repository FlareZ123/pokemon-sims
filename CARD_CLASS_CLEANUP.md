...
- `kRegisteredCardDefinitions` is the single explicit list of migrated definitions. Brilliant Blender, Battle VIP Pass, Quick Ball, Professor's Letter, Evolution Incense, Mysterious Treasure, and Hisuian Heavy Ball now use that inventory; future migrations append one definition there instead of extending a lookup switch. Battle VIP Pass source: https://api.pokemontcg.io/v2/cards/swsh8-225 Hisuian Heavy Ball source: https://api.pokemontcg.io/v2/cards/swsh10-146
