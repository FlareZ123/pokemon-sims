...
- `src/trace_engine_v2/core/locks/garbodor_policy.inc` is the canonical Garbodor scenario-timing and Ability-lock policy owner. `GarbodorScenarioPolicy` and `GarbodorAbilityLockPolicy` are explicit final stateless classes. The historical `src/trace_engine_v2/core/garbodor_lock_policy.inc` path is a compatibility include while source-contract references migrate. Garbodor / Garbotoxin: https://api.pokemontcg.io/v2/cards/xy9-57 Boost Shake: https://api.pokemontcg.io/v2/cards/swsh7-142 Path to the Peak: https://api.pokemontcg.io/v2/cards/swsh6-148
...
- Garbodor scenario and Ability-lock composition: `src/trace_engine_v2/core/locks/garbodor_policy.inc`; keep `src/trace_engine_v2/core/garbodor_lock_policy.inc` only as the temporary source-contract compatibility path. Garbodor: https://api.pokemontcg.io/v2/cards/xy9-57
