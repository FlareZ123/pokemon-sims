...
1. Keep `composition/steven_blender_overrides.inc` as the canonical Steven/Blender composition boundary. Continue deleting redundant forwarding layers only after repository-wide and source-contract references are proven gone.
