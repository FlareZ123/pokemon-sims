...
- `src/trace_engine_v2/core/locks/garbodor_policy.inc` is the canonical Garbodor scenario-timing and Ability-lock policy owner. `GarbodorScenarioPolicy` and `GarbodorAbilityLockPolicy` are explicit final stateless classes. `composition/engine_body.inc` and `src/regidrago_sim.cpp` reference the canonical organized path directly, and the historical `src/trace_engine_v2/core/garbodor_lock_policy.inc` forwarding include is retired after repository-wide consumers moved away from it. Garbodor / Garbotoxin: https://api.pokemontcg.io/v2/cards/xy9-57 Boost Shake: https://api.pokemontcg.io/v2/cards/swsh7-142 Path to the Peak: https://api.pokemontcg.io/v2/cards/swsh6-148
...
- Garbodor scenario and Ability-lock composition: `src/trace_engine_v2/core/locks/garbodor_policy.inc`; Engine composition and the root source registry use this canonical path directly. The historical `src/trace_engine_v2/core/garbodor_lock_policy.inc` forwarding seam is retired and should not be recreated. Garbodor: https://api.pokemontcg.io/v2/cards/xy9-57
...
20. Keep Engine composition and the root source registry on `core/locks/garbodor_policy.inc`; the historical `core/garbodor_lock_policy.inc` compatibility include is retired and should not be recreated. Preserve scenario timing and Ability-lock composition in the final stateless policy classes while Engine retains live scenario/state reads and shared lock-removal state. Garbodor / Garbotoxin: https://api.pokemontcg.io/v2/cards/xy9-57 Boost Shake: https://api.pokemontcg.io/v2/cards/swsh7-142 Path to the Peak: https://api.pokemontcg.io/v2/cards/swsh6-148
