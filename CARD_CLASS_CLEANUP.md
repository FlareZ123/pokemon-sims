...
- `src/trace_engine_v2/core/routes/battle_compressor_vs_seeker_policy.inc` is the canonical Battle Compressor / VS Seeker route owner. `composition/engine_body.inc` now includes this owner directly, and the historical `src/trace_engine_v2/core/battle_compressor_vs_seeker_policy.inc` compatibility path is retired. Battle Compressor: https://api.pokemontcg.io/v2/cards/xy4-92 VS Seeker: https://api.pokemontcg.io/v2/cards/xy4-109 Advanced procedure: https://github.com/FlareZ123/pokemon-sims/blob/main/EN_advanced_manual-2025-transcription-structured.md
...
14. Migrate composition and source-contract references from `core/routes/steven_package_policy.inc` to `core/routes/steven/package.inc`, then retire the historical Steven package compatibility include after repository-wide references are proven gone.
