...
The issue-1393 held-Crispin completion helper remains owned by `src/trace_engine_v2/core/routes/crispin_supported_route_policy.inc`, and `part_issue_1356_fss_energy_override.inc` now composes that canonical owner directly at the established member boundary. The forwarding-only `part_issue_1393_crispin_route_helper.inc` seam has been retired. Route code, DDE-aware projection, K1/JIT policy, and direct rules/card sources remain together under `core/routes/`. Crispin: https://api.pokemontcg.io/v2/cards/sv7-133 Double Dragon Energy: https://api.pokemontcg.io/v2/cards/xy6-97 Advanced procedure: https://github.com/FlareZ123/pokemon-sims/blob/main/EN_advanced_manual-2025-transcription-structured.md Canonical owner: https://github.com/FlareZ123/pokemon-sims/blob/main/src/trace_engine_v2/core/routes/crispin_supported_route_policy.inc Composition consumer: https://github.com/FlareZ123/pokemon-sims/blob/main/src/trace_engine_v2/part_issue_1356_fss_energy_override.inc
