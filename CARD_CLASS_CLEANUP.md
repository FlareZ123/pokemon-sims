...
The issue-3221 K0 Steven/Brilliant Blender route has a canonical semantic owner at `src/trace_engine_v2/core/routes/k0_steven_blender_semantic_policy.inc`. The historical root `part_issue_3221_k0_steven_blender_semantic_override.inc` forwarding seam is retired after repository search found no direct source-contract, generator, or composition consumer. The complete function body and its K0, projected Item-lock, JIT, and direct source documentation remain together under `core/routes/`, so textual declaration order and route semantics are unchanged. Brilliant Blender: https://api.pokemontcg.io/v2/cards/sv8-164 Steven's Resolve: https://api.pokemontcg.io/v2/cards/sm7-145 Regidrago VSTAR: https://api.pokemontcg.io/v2/cards/swsh12-136 Advanced procedure: https://github.com/FlareZ123/pokemon-sims/blob/main/EN_advanced_manual-2025-transcription-structured.md Canonical owner: https://github.com/FlareZ123/pokemon-sims/blob/main/src/trace_engine_v2/core/routes/k0_steven_blender_semantic_policy.inc

The issue-3222 Steven/Brilliant Blender semantic route has a canonical owner at `src/trace_engine_v2/core/routes/steven_blender_semantic_policy.inc`. The historical root `part_issue_3222_steven_blender_semantic_override.inc` forwarding seam is retired after repository search found no direct consumer. Gameplay predicates, source URLs, and Engine-member placement remain owned by the canonical route file. Canonical owner: https://github.com/FlareZ123/pokemon-sims/blob/main/src/trace_engine_v2/core/routes/steven_blender_semantic_policy.inc C++ textual include semantics: https://eel.is/c++draft/cpp.include
