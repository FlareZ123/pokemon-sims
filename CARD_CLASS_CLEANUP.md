...
Tate & Liza now owns exact Celestial Storm `sm7-148` Trainer/Supporter metadata in `src/cards/trainers/tate_liza.hpp`, is explicitly registered, and no longer depends on the legacy name or Supporter fallback. Both printed modes, Supporter contention, DCI/UDP/AMR, connector domination, K0/K1, and route choice remain at their existing Engine owners. Exact print: https://raw.githubusercontent.com/PokemonTCG/pokemon-tcg-data/master/cards/en/sm7.json Migration: https://github.com/FlareZ123/pokemon-sims/issues/3562
