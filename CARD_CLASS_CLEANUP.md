...
`src/trace_engine_v2/part_forretress_ex_combo.inc` now owns the Garbodor scenario extension directly beside the `core/forretress/runtime.inc` include. The one-owner `src/trace_engine_v2/core/forretress/scenarios.inc` fragment is retired. The scenario rows and lookup order remain unchanged. Garbodor: https://api.pokemontcg.io/v2/cards/xy9-57 Boost Shake: https://api.pokemontcg.io/v2/cards/swsh7-142 Scenario specification: https://github.com/FlareZ123/pokemon-sims/issues/2808
