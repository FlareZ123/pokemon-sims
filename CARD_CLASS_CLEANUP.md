...
The Forretress runtime now centralizes three repeated orchestration predicates at the existing card-facing contract: `forretress_line_in_play()` owns exact Pineco/Forretress public-board count membership, while `normally_evolvable_pineco_in_play()` and `current_turn_pineco_in_play()` own the complementary Active-first prior-turn and entry-turn Pineco queries. Connector admission, Bench setup, Dawn Basic selection, and Forest of Vitality planning reuse those seams without moving state-count semantics, route order, or evolution resolution. Pineco: https://api.pokemontcg.io/v2/cards/sv4pt5-1 Forretress ex: https://api.pokemontcg.io/v2/cards/sv4pt5-2 Forest of Vitality: https://api.pokemontcg.io/v2/cards/me1-117 Advanced evolution procedure: https://github.com/FlareZ123/pokemon-sims/blob/main/EN_advanced_manual-2025-transcription-structured.md Runtime owner: https://github.com/FlareZ123/pokemon-sims/blob/main/src/trace_engine_v2/core/forretress/runtime.inc

Next mechanical Forretress step: inventory adjacent root route fragments for another complete semantic boundary, and reuse the new board-count or evolution-timing predicates only where the semantics are identical. Preserve exact Pineco-versus-Forretress distinctions where a route needs one stage specifically, plus entry-turn evolution timing, route ordering, attachment distribution, retreat planning, and strategic ranking at their existing owners. Forest of Vitality: https://api.pokemontcg.io/v2/cards/me1-117 Core evolution rules: https://www.pokemon.com/us/pokemon-tcg/rules Official February 2026 ruling: https://professorprogram.pokemon.com/news/11473085
