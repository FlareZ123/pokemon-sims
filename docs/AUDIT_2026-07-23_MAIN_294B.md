...
This documentation-only audit is bound to `main@294b408bdab0774ef49d4cd73236dabcffe4173f` and changes no simulator logic. The branch-only CI comment exists solely to trigger the approved permanent workflow and will not be merged.
