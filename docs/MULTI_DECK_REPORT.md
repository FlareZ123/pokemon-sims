...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Strict JIT, going first | 12.188% | 19.419% | +7.231 pp | 39.982% | 47.988% | +8.006 pp | 56.956% | 66.001% | +9.045 pp |
| Strict JIT, going second | 29.961% | 47.541% | +17.580 pp | 53.883% | 63.249% | +9.366 pp | 65.219% | 73.837% | +8.618 pp |
...
|---|---:|---:|---:|---:|
| Strict JIT, going first | 12.188% ± 0.103 | 39.982% ± 0.155 | 56.956% ± 0.157 | 43.044% ± 0.157 |
...
| Strict JIT, Rule Box Ability lock, first | 4.448% ± 0.065 | 26.439% ± 0.139 | 40.099% ± 0.155 | 59.901% ± 0.155 |
| Strict JIT, combined lock, first | 0.304% ± 0.017 | 3.357% ± 0.057 | 7.499% ± 0.083 | 92.501% ± 0.083 |
| Strict JIT, going second | 29.961% ± 0.145 | 53.883% ± 0.158 | 65.219% ± 0.151 | 34.781% ± 0.151 |
...
| Strict JIT, Rule Box Ability lock, second | 18.212% ± 0.122 | 35.510% ± 0.151 | 46.001% ± 0.158 | 53.999% ± 0.158 |
...
| Strict JIT, Supporter lock, second | 8.119% ± 0.086 | 19.409% ± 0.125 | 25.307% ± 0.137 | 74.693% ± 0.137 |

### First-ready-turn distribution

| Scenario | Ready on T2 | Ready on T3 | Ready on T4 | Ready on T5 diagnostic |
|---|---:|---:|---:|---:|
| Strict JIT, going first | 12.188% | 27.794% | 16.974% | 10.552% |
| Matchup-flex JIT, going first | 16.343% | 31.950% | 15.750% | 9.566% |
| No discard control, going first | 19.958% | 36.062% | 16.336% | 9.010% |
| Strict JIT, going second | 29.961% | 23.922% | 11.336% | 7.784% |
...
| Scenario | T2 ± SE | T3 ± SE | T4 ± SE | Failure ± SE |
|---|---:|---:|---:|---:|
| Strict JIT, going first | 19.419% ± 0.125 | 47.988% ± 0.158 | 66.001% ± 0.150 | 33.999% ± 0.150 |
...
| Strict JIT, Rule Box Ability lock, first | 4.945% ± 0.069 | 18.320% ± 0.122 | 30.473% ± 0.146 | 69.527% ± 0.146 |
| Strict JIT, combined lock, first | 0.502% ± 0.022 | 1.448% ± 0.038 | 3.288% ± 0.056 | 96.712% ± 0.056 |
| Strict JIT, going second | 47.541% ± 0.158 | 63.249% ± 0.152 | 73.837% ± 0.139 | 26.163% ± 0.139 |
...
Simulator policy digest: `b6fa72c69976d17a753b6cbe0474b21b3208d246e41c4ec955b2d6099e935f0f`.

Comparison CSV SHA-256: `b5313f03b86ba4c6532d573645bbb4227e35cd96f6277889330be55838ce3253`.
