...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Strict JIT, going first | 12.179% | 19.762% | +7.583 pp | 41.288% | 49.001% | +7.713 pp | 58.238% | 66.554% | +8.316 pp |
| Strict JIT, going second | 29.838% | 48.305% | +18.467 pp | 54.556% | 64.267% | +9.711 pp | 66.101% | 74.630% | +8.529 pp |
...
|---|---:|---:|---:|---:|
| Strict JIT, going first | 12.179% ± 0.103 | 41.288% ± 0.156 | 58.238% ± 0.156 | 41.762% ± 0.156 |
...
| Strict JIT, Rule Box Ability lock, first | 4.451% ± 0.065 | 26.815% ± 0.140 | 40.532% ± 0.155 | 59.468% ± 0.155 |
| Strict JIT, turn-two Item + Rule Box Ability lock, first | 0.814% ± 0.028 | 4.665% ± 0.067 | 9.585% ± 0.093 | 90.415% ± 0.093 |
| Strict JIT, going second | 29.838% ± 0.145 | 54.556% ± 0.157 | 66.101% ± 0.150 | 33.899% ± 0.150 |
...
| Strict JIT, Rule Box Ability lock, second | 18.514% ± 0.123 | 35.939% ± 0.152 | 46.816% ± 0.158 | 53.184% ± 0.158 |
...
Simulator policy digest: `bc01a1511c4fab3acc6e00fe5ed7e823ae0ceca2f5a0859e590ddde464dca82c`.

Comparison CSV SHA-256: `0a9a39224f4b595b9f8388dff7301d5cabdb8a984aa85dcfa0707ffb65b05f95`.
