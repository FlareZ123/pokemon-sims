...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Strict JIT, going first | 12.237% | 19.618% | +7.381 pp | 41.796% | 49.028% | +7.232 pp | 59.092% | 66.763% | +7.671 pp |
| Strict JIT, going second | 29.728% | 48.445% | +18.717 pp | 55.386% | 64.490% | +9.104 pp | 67.350% | 74.933% | +7.583 pp |
| Matchup-flex JIT, going first | 16.992% | 21.175% | +4.183 pp | 50.082% | 50.717% | +0.635 pp | 67.676% | 68.714% | +1.038 pp |
| Matchup-flex JIT, going second | 37.015% | 51.470% | +14.455 pp | 63.918% | 67.437% | +3.519 pp | 75.613% | 77.077% | +1.464 pp |
...
|---|---:|---:|---:|---:|
| Strict JIT, going first | 12.237% ± 0.104 | 41.796% ± 0.156 | 59.092% ± 0.155 | 40.908% ± 0.155 |
| Matchup-flex JIT, going first | 16.992% ± 0.119 | 50.082% ± 0.158 | 67.676% ± 0.148 | 32.324% ± 0.148 |
| No discard control, going first | 19.740% ± 0.126 | 56.829% ± 0.157 | 73.585% ± 0.139 | 26.415% ± 0.139 |
| Strict JIT, turn-two Item lock, first | 4.518% ± 0.066 | 10.488% ± 0.097 | 18.657% ± 0.123 | 81.343% ± 0.123 |
...
| Strict JIT, going second | 29.728% ± 0.145 | 55.386% ± 0.157 | 67.350% ± 0.148 | 32.650% ± 0.148 |
| Matchup-flex JIT, going second | 37.015% ± 0.153 | 63.918% ± 0.152 | 75.613% ± 0.136 | 24.387% ± 0.136 |
| No discard control, going second | 40.232% ± 0.155 | 68.436% ± 0.147 | 79.981% ± 0.127 | 20.019% ± 0.127 |
| Strict JIT, turn-two Item lock, second | 14.160% ± 0.110 | 28.594% ± 0.143 | 37.375% ± 0.153 | 62.625% ± 0.153 |
...
| Garbodor + Boost Shake Ability lock, first | 5.584% ± 0.073 | 26.981% ± 0.140 | 40.896% ± 0.155 | 59.104% ± 0.155 |
| Garbodor + Boost Shake Ability lock, second | 17.452% ± 0.120 | 34.879% ± 0.151 | 46.591% ± 0.158 | 53.409% ± 0.158 |

### First-ready-turn distribution

| Scenario | Ready on T2 | Ready on T3 | Ready on T4 | Ready on T5 diagnostic |
|---|---:|---:|---:|---:|
| Strict JIT, going first | 12.237% | 29.559% | 17.296% | 10.971% |
| Matchup-flex JIT, going first | 16.992% | 33.090% | 17.594% | 10.242% |
| No discard control, going first | 19.740% | 37.089% | 16.756% | 9.045% |
| Strict JIT, going second | 29.728% | 25.658% | 11.964% | 8.012% |
| Matchup-flex JIT, going second | 37.015% | 26.903% | 11.695% | 7.035% |
...
Simulator policy digest: `853a94a5ed6b1a3fd13f0595eaaeedd41bab113b3cce410ffbf4743e15ff7d78`.

Comparison CSV SHA-256: `1a173841e08b0f67287e69e2c9dc47854aeaa33693c3cef4ae3277eebb16035e`.
