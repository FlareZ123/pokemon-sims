...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Strict JIT, going first | 12.232% | 19.665% | +7.433 pp | 39.956% | 48.358% | +8.402 pp | 56.868% | 66.155% | +9.287 pp |
| Strict JIT, going second | 29.896% | 47.655% | +17.759 pp | 53.768% | 63.147% | +9.379 pp | 65.037% | 73.726% | +8.689 pp |
| Matchup-flex JIT, going first | 16.341% | 20.924% | +4.583 pp | 48.085% | 49.660% | +1.575 pp | 64.051% | 67.997% | +3.946 pp |
| Matchup-flex JIT, going second | 37.456% | 51.258% | +13.802 pp | 61.250% | 66.642% | +5.392 pp | 71.452% | 76.410% | +4.958 pp |
...
|---|---:|---:|---:|---:|
| Strict JIT, going first | 12.232% ± 0.104 | 39.956% ± 0.155 | 56.868% ± 0.157 | 43.132% ± 0.157 |
| Matchup-flex JIT, going first | 16.341% ± 0.117 | 48.085% ± 0.158 | 64.051% ± 0.152 | 35.949% ± 0.152 |
...
| Strict JIT, Rule Box Ability lock, first | 4.351% ± 0.065 | 26.604% ± 0.140 | 39.984% ± 0.155 | 60.016% ± 0.155 |
| Strict JIT, combined lock, first | 0.302% ± 0.017 | 3.246% ± 0.056 | 7.393% ± 0.083 | 92.607% ± 0.083 |
| Strict JIT, going second | 29.896% ± 0.145 | 53.768% ± 0.158 | 65.037% ± 0.151 | 34.963% ± 0.151 |
| Matchup-flex JIT, going second | 37.456% ± 0.153 | 61.250% ± 0.154 | 71.452% ± 0.143 | 28.548% ± 0.143 |
...
| Strict JIT, Rule Box Ability lock, second | 18.085% ± 0.122 | 35.355% ± 0.151 | 45.894% ± 0.158 | 54.106% ± 0.158 |
...
| Strict JIT, Supporter lock, second | 8.196% ± 0.087 | 19.693% ± 0.126 | 25.505% ± 0.138 | 74.495% ± 0.138 |

### First-ready-turn distribution

| Scenario | Ready on T2 | Ready on T3 | Ready on T4 | Ready on T5 diagnostic |
|---|---:|---:|---:|---:|
| Strict JIT, going first | 12.232% | 27.724% | 16.912% | 10.425% |
| Matchup-flex JIT, going first | 16.341% | 31.744% | 15.966% | 9.514% |
| No discard control, going first | 19.985% | 36.055% | 16.335% | 9.000% |
| Strict JIT, going second | 29.896% | 23.872% | 11.269% | 7.802% |
| Matchup-flex JIT, going second | 37.456% | 23.794% | 10.202% | 6.902% |
...
Simulator policy digest: `7971c4d7236d94170b43cc0d694aca30b1f3c26bd9c7a042c884d958080cd69e`.

Comparison CSV SHA-256: `37db58d6b017d55fdee6f27fb6dab08cfb9a1cb64724c140570558b4a2506f20`.
