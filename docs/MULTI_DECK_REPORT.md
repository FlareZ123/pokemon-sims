...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Strict JIT, going first | 12.270% | 19.542% | +7.272 pp | 41.114% | 48.741% | +7.627 pp | 57.847% | 66.461% | +8.614 pp |
| Strict JIT, going second | 29.808% | 47.755% | +17.947 pp | 54.247% | 63.629% | +9.382 pp | 65.589% | 74.200% | +8.611 pp |
...
|---|---:|---:|---:|---:|
| Strict JIT, going first | 12.270% ± 0.104 | 41.114% ± 0.156 | 57.847% ± 0.156 | 42.153% ± 0.156 |
...
| Strict JIT, Rule Box Ability lock, first | 4.466% ± 0.065 | 26.834% ± 0.140 | 40.282% ± 0.155 | 59.718% ± 0.155 |
| Strict JIT, turn-two Item + Rule Box Ability lock, first | 0.812% ± 0.028 | 4.674% ± 0.067 | 9.572% ± 0.093 | 90.428% ± 0.093 |
| Strict JIT, going second | 29.808% ± 0.145 | 54.247% ± 0.158 | 65.589% ± 0.150 | 34.411% ± 0.150 |
...
| Strict JIT, Rule Box Ability lock, second | 18.486% ± 0.123 | 35.816% ± 0.152 | 46.554% ± 0.158 | 53.446% ± 0.158 |
...
| Scenario | T2 ± SE | T3 ± SE | T4 ± SE | Failure ± SE |
|---|---:|---:|---:|---:|
| Strict JIT, going first | 19.542% ± 0.125 | 48.741% ± 0.158 | 66.461% ± 0.149 | 33.539% ± 0.149 |
...
| Strict JIT, Rule Box Ability lock, first | 4.918% ± 0.068 | 18.562% ± 0.123 | 30.625% ± 0.146 | 69.375% ± 0.146 |
| Strict JIT, turn-two Item + Rule Box Ability lock, first | 0.968% ± 0.031 | 2.394% ± 0.048 | 4.947% ± 0.069 | 95.053% ± 0.069 |
| Strict JIT, going second | 47.755% ± 0.158 | 63.629% ± 0.152 | 74.200% ± 0.138 | 25.800% ± 0.138 |
...
| Strict JIT, Rule Box Ability lock, second | 12.546% ± 0.105 | 24.741% ± 0.136 | 34.425% ± 0.150 | 65.575% ± 0.150 |
...
Simulator policy digest: `8f985096d059fcd85751788b53da60a38ba3c623367a54f868255ad0c4a8a29a`.

Comparison CSV SHA-256: `8662bfe8d076d15aea323106d64557b5857db339cdf0173c4f85acf22ceb35ca`.
