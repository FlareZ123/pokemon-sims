...
20. **Blocks Tapu Lele-GX Wonder Tag through Rule Box lock.** Initial: `T1 going second; A Regidrago V[-]; H Tapu Lele-GX; D Crispin; full Rule Box lock`. Pass: Tapu is Benched, but Crispin is not searched.
