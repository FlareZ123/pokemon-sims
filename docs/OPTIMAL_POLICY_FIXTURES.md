...
26. **Does not play Arven into current Item lock.** Initial: `T2; A Regidrago V[-]; H Arven; D Evolution Incense, Forest Seal Stone; full Item lock`. Pass: Arven is held.
