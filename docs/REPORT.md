...
| Scenario | T2 | T3 | T4 |
|---|---:|---:|---:|
| Strict JIT, going first | 11.935% | 38.538% | 55.408% |
...
| Strict JIT, Rule Box Ability lock, first | 4.467% | 25.989% | 39.071% |
...
| Strict JIT, Rule Box Ability lock, second | 18.117% | 34.705% | 44.836% |
