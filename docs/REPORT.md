...
| Scenario | T2 | T3 | T4 |
|---|---:|---:|---:|
| Strict JIT, going first | 11.949% | 39.553% | 56.657% |
| Matchup-flex JIT, going first | 16.375% | 48.35% | 64.141% |
| No discard control, going first | 19.977% | 56.028% | 72.361% |
| Strict JIT, going second | 29.681% | 53.793% | 65.068% |
| Matchup-flex JIT, going second | 37.177% | 61.168% | 71.369% |
...
| Strict JIT, Rule Box Ability lock, first | 4.341% | 26.61% | 40.334% |
...
| Strict JIT, Rule Box Ability lock, second | 18.253% | 35.552% | 46.117% |
