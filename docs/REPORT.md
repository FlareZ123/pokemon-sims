...
| Scenario | T2 | T3 | T4 |
|---|---:|---:|---:|
| Strict JIT, going first | 12.27% | 41.114% | 57.847% |
| Matchup-flex JIT, going first | 16.581% | 49.341% | 65.258% |
| No discard control, going first | 19.958% | 56.02% | 72.356% |
| Strict JIT, going second | 29.808% | 54.247% | 65.589% |
| Matchup-flex JIT, going second | 37.743% | 62.317% | 72.774% |
...
| Strict JIT, Rule Box Ability lock, first | 4.466% | 26.834% | 40.282% |
...
| Strict JIT, Rule Box Ability lock, second | 18.486% | 35.816% | 46.554% |
