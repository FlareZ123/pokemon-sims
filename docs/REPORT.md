...
| Scenario | T2 | T3 | T4 |
|---|---:|---:|---:|
| Strict JIT, going first | 12.044% | 41.127% | 58.051% |
| Matchup-flex JIT, going first | 16.566% | 49.738% | 65.487% |
| No discard control, going first | 19.958% | 56.02% | 72.356% |
| Strict JIT, going second | 29.781% | 54.292% | 65.832% |
| Matchup-flex JIT, going second | 37.037% | 62.065% | 72.777% |
...
| Strict JIT, Rule Box Ability lock, first | 4.484% | 26.857% | 40.415% |
...
| Strict JIT, Rule Box Ability lock, second | 18.506% | 35.947% | 46.781% |
