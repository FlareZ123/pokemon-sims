...
| Scenario | T2 | T3 | T4 |
|---|---:|---:|---:|
| Strict JIT, turn-two Item lock, first | 4.518% | 10.488% | 18.657% |
...
| Strict JIT, turn-two Item lock, second | 14.16% | 28.594% | 37.375% |
...
| Garbodor + Boost Shake Ability lock, first | 5.584% | 26.981% | 40.896% |
| Garbodor + Boost Shake Ability lock, second | 17.452% | 34.879% | 46.591% |
