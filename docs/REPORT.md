...
| Scenario | T2 | T3 | T4 |
|---|---:|---:|---:|
| Strict JIT, going first | 11.513% | 35.535% | 50.82% |
| Matchup-flex JIT, going first | 16.064% | 44.258% | 59.802% |
| No discard control, going first | 19.623% | 54.848% | 71.281% |
| Strict JIT, going second | 27.638% | 48.791% | 59.539% |
| Matchup-flex JIT, going second | 35.373% | 57.624% | 68.332% |
...
| Strict JIT, Rule Box Ability lock, first | 4.365% | 23.562% | 35.748% |
...
| Strict JIT, Rule Box Ability lock, second | 17.447% | 32.505% | 42.066% |
