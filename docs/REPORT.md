...
| Scenario | T2 | T3 | T4 |
|---|---:|---:|---:|
| Strict JIT, going first | 12.302% | 41.192% | 57.894% |
| Matchup-flex JIT, going first | 16.574% | 49.316% | 65.239% |
| No discard control, going first | 19.958% | 56.02% | 72.356% |
| Strict JIT, going second | 29.744% | 54.185% | 65.482% |
...
| Strict JIT, Rule Box Ability lock, first | 4.471% | 26.779% | 40.269% |
...
| Strict JIT, Rule Box Ability lock, second | 18.45% | 35.777% | 46.43% |
