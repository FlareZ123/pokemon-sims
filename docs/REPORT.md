...
| Scenario | T2 | T3 | T4 |
|---|---:|---:|---:|
| Strict JIT, going first | 12.177% | 40.905% | 57.576% |
| Matchup-flex JIT, going first | 16.541% | 49.238% | 64.738% |
| No discard control, going first | 19.958% | 56.02% | 72.356% |
| Strict JIT, going second | 29.843% | 54.073% | 65.45% |
| Matchup-flex JIT, going second | 37.565% | 61.758% | 72.097% |
...
| Strict JIT, Rule Box Ability lock, first | 4.502% | 26.775% | 40.202% |
...
| Strict JIT, Rule Box Ability lock, second | 18.253% | 35.714% | 46.281% |
