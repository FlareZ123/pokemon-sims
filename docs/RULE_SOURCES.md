...
| https://github.com/FlareZ123/pokemon-sims/issues/2808 | Model Boost Shake timing into Garbotoxin, suppress Pokemon Abilities while Garbodor is tooled, preserve Forest Seal Stone's Tool Ability, and spend Field Blower only when its current-turn Tool removal unlocks a live setup route | https://api.pokemontcg.io/v2/cards/xy9-57, https://api.pokemontcg.io/v2/cards/swsh7-142, https://api.pokemontcg.io/v2/cards/sm2-125, https://api.pokemontcg.io/v2/cards/swsh12-156, https://compendium.pokegym.net/category/5-trainers/forest-seal-stone/ | `opening_engine_overrides.inc`, `part_014c_field_blower_override.inc`, `empty_deck_search_overrides.inc`, `no_redundant_item_tests.cpp` |

All listed boundaries also cite the official turn, Trainer, evolution, attachment, Ability, attack, and Retreat procedures at https://www.pokemon.com/us/pokemon-tcg/rules and the repository's earliest-complete-route and strict-JIT specifications in `POLICY_DECISIONS.md` and `MODEL_ASSUMPTIONS.md`.
...
- The `garbodor-shake-ability-lock` scenario is a paper-Expanded opponent-pressure model. Going first, Regidrago T1 occurs before the opponent's Boost Shake turn and Garbotoxin begins on Regidrago T2. Going second, the opponent's Boost Shake turn has already occurred and Garbotoxin begins on Regidrago T1. A successful Field Blower unlock is scoped to the current Regidrago turn because the scenario assumes the maximum-pressure opponent attaches another Tool before the next turn: https://api.pokemontcg.io/v2/cards/xy9-57 https://api.pokemontcg.io/v2/cards/swsh7-142 https://api.pokemontcg.io/v2/cards/sm2-125 https://github.com/FlareZ123/pokemon-sims/issues/2808
- Forest Seal Stone remains usable under Path to the Peak and the Garbotoxin scenario. The published ruling explains that the Pokémon V does not have Star Alchemy; it has access to the Ability printed on the attached Tool: https://compendium.pokegym.net/category/5-trainers/forest-seal-stone/
