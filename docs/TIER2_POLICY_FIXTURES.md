...
8. **FSS takes direct Arven instead of a Tapu chain.** `T2; A Regidrago V[G] with FSS; H VSTAR; D Arven, Mysterious Treasure, Tapu Lele-GX; X/DTT Mega Dragonite ex`. Required: Star Alchemy gets Arven, not Mysterious Treasure or Tapu Lele-GX.
9. **FSS takes Blender for current-turn payload.** `T2; A Regidrago V[GGF] with FSS; H VSTAR; D Brilliant Blender, Arven, Mega Dragonite ex`. Required: Star Alchemy gets Blender, then Blender discards Mega Dragonite ex this turn.
10. **Known Lusamine is delayed, not direct.** `T2; A Regidrago V[G]; H VSTAR, Mysterious Treasure, Dipplin, Gladion; D Tapu Lele-GX; P Lusamine; X Crispin, Professor Burnet`. Required: Treasure legally creates K1, Gladion takes Lusamine only because no direct Supporter route exists, and on T3 Lusamine returns Crispin plus Burnet.
11. **Search knowledge persists.** State A: `T2; A Latias ex[-]; H Quick Ball, Dipplin; D Regidrago V`. Required: Quick Ball creates K1. State B: `T2; A Latias ex[-]; H Heavy Ball; P Regidrago V`. Required: Heavy Ball creates K1.
