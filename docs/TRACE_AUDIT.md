...
| Strict JIT, going first | `strict-jit/go-first`, seed `1` / [`strict_jit_go_first_seed_1.txt`](../results/traces/strict_jit_go_first_seed_1.txt) | T4 | Saved executable audit example reproduced from the manifest. |
