...
|---|---|---:|---|
| Strict JIT, going second | `strict-jit/go-second`, seed `1` / [`strict_jit_go_second_seed_1.txt`](../results/traces/strict_jit_go_second_seed_1.txt) | T3 | Saved executable audit example reproduced from the manifest. |
...
| Strict JIT, turn-two Item lock, second | `strict-jit-turn2-item-lock/go-second`, seed `2` / [`strict_turn2_item_lock_go_second_seed_2.txt`](../results/traces/strict_turn2_item_lock_go_second_seed_2.txt) | T2 | Saved executable audit example reproduced from the manifest. |
