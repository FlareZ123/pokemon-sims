...
def main() -> None:
    replace_once(
        ROOT / "src/trace_engine_v2/part_empty_deck_search_override.inc",
...
""",
    ...
    replace_once(
        ROOT / "src/trace_engine_v2/part_012_override.inc",
        """        for (const Card payload : {Card::MegaDragonite, Card::Dragapult,
                                   Card::GoodraVstar, Card::DialgaGX}) {
""",
...
""",
    ...
    replace_once(
        ROOT / "src/trace_engine_v2/part_forretress_ex_combo.inc",
...
""",
    ...
    atomic_write(ROOT / "tests/issue_1254_ultra_ball_appletun_continuation_tests.cpp", r'''#define REGIDRAGO_SIM_NO_MAIN
