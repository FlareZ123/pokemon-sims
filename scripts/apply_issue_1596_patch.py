...
Path("tests/issue_1596_turo_vessel_dialga_tests.cpp").write_text(
    dedent(
        r'''\
        ...
        void test_seed_26_plays_turo_before_vessel() {
          ...
          // Turo returns Dialga-GX before Vessel pays its cost. The returned Dragon is
          // then the legal current-turn payload and Fire completes GGF:
