...
Path("tests/issue_1599_quick_ball_tapu_crispin_tests.cpp").write_text(
    dedent(
        ...
        void test_seed_24_finishes_on_turn_two() {
          ...
          // The held Quick Ball can spend Goodra, search Tapu Lele-GX, and Wonder Tag
          // Crispin after Mysterious Treasure has already established the T2 payload
          // and VSTAR axes. Crispin then supplies the missing Fire attachment:
          // Quick Ball: https://api.pokemontcg.io/v2/cards/swsh1-179
