...
The saved traces are independent audit examples. They are not asserted to use the same seeds or exact first-ready turns as the separately registered CTest deadline regressions in `CMakeLists.txt`: https://github.com/FlareZ123/pokemon-sims/blob/main/CMakeLists.txt
