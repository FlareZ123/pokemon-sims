...
inline constexpr std::array<const CardDefinition*, 9> kRegisteredCardDefinitions{
    ...
    &PathToThePeak::definition, // Exact SWSH 148 Stadium metadata: https://api.pokemontcg.io/v2/cards/swsh6-148
};
...
constexpr bool registered_is_stadium(const Card card) {
  return registered_is_trainer_kind(card, TrainerKind::Stadium); // Stadium classification source: https://api.pokemontcg.io/v2/cards/swsh6-148
}
