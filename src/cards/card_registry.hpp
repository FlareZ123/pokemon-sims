...
inline constexpr std::array<const CardDefinition*, 20> kRegisteredCardDefinitions{
    ...
    &Guzma::definition, // Exact Burning Shadows Supporter: https://api.pokemontcg.io/v2/cards/sm3-115 ; enhancement: https://github.com/FlareZ123/pokemon-sims/issues/3618
