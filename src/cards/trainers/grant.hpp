...
class Grant final {
 public:
  static constexpr CardDefinition definition{
      ...
      .trainer_kind = TrainerKind::Supporter, // Exact subtype and one-Supporter reminder: https://api.pokemontcg.io/v2/cards/swsh10-144
      .source_url = "https://api.pokemontcg.io/v2/cards/swsh10-144", // Cleanup issue: https://github.com/FlareZ123/pokemon-sims/issues/3589
  };
};
