// Keep the historical simulator implementation intact in regidrago_sim_engine.cpp.
// This entry wrapper adds the repository's Pokémon TCG Live card-pool boundary.
#ifndef REGIDRAGO_SIM_NO_MAIN
#define main pokemon_sims_paper_expanded_main
#endif
#include "regidrago_sim_engine.cpp"
#ifndef REGIDRAGO_SIM_NO_MAIN
#undef main
#endif
...
int main(int argc, char** argv) {
  ...
  if (paper_expanded_model) {
    // Double Dragon Energy remains available only through an explicit paper-
    // Expanded modeling opt-in because its XY print is unavailable in TCG Live:
