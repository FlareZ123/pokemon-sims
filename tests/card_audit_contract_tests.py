...
CANONICAL_SOURCE_CARD_IDS = {
    ...
    "xy1-123", "xy4-92", "xy4-109", "xy6-97", "xy9-57",  # Phantom Forces Items: https://api.pokemontcg.io/v2/cards/xy4-92 https://api.pokemontcg.io/v2/cards/xy4-109 ; Garbodor: https://api.pokemontcg.io/v2/cards/xy9-57
}
