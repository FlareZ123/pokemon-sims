...
void test_registry_metadata_and_supporter_classification() {
  ...
  require(definition->canonical_id == "sv3pt5-160",
          "Erika's Invitation canonical print changed.");  // Exact card data: https://api.pokemontcg.io/v2/cards/sv3pt5-160
  ...
  require(definition->kind == sim::cards::CardKind::Trainer,
          "Erika's Invitation must remain a Trainer.");  // Exact card data: https://api.pokemontcg.io/v2/cards/sv3pt5-160
  require(definition->trainer_kind == sim::cards::TrainerKind::Supporter,
          "Erika's Invitation must remain a Supporter.");  // Supporter procedure: https://github.com/FlareZ123/pokemon-sims/blob/main/EN_advanced_manual-2025-transcription-structured.md
