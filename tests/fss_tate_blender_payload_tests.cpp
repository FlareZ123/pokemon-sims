...
void test_blender_holds_for_live_fss_tate_connector_with_incomplete_target() {
  ...
  // Star Alchemy correctly preserves its one-per-game search when Tate would promote
  // an Energy-incomplete VSTAR. Brilliant Blender must preserve the matching one-shot
...
void test_blender_resolves_when_fss_tate_target_is_energy_complete() {
  ...
  // so Blender may legally supply the strict-JIT Dragon payload this turn:
  // https://api.pokemontcg.io/v2/cards/swsh12-156
  // https://api.pokemontcg.io/v2/cards/sm7-148
  // https://api.pokemontcg.io/v2/cards/sv8-164
  // https://api.pokemontcg.io/v2/cards/swsh12-136
