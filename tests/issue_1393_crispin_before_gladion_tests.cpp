...
void test_action_specific_lock_semantics() {
  ...
  // Crispin is a Supporter and Brilliant Blender is an Item. A Rule Box Ability
  // lock leaves both actions legal, while a Supporter or current-turn Item lock
  // blocks an action this exact route requires:
  // Crispin: https://api.pokemontcg.io/v2/cards/sv7-133
  // Brilliant Blender: https://api.pokemontcg.io/v2/cards/sv8-164
