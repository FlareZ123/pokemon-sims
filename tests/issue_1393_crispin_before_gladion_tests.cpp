...
void test_action_specific_lock_semantics() {
  ...
  // Rule Box Ability suppression does not prohibit either Trainer class. Supporter
  // or turn-two Item lock blocks a required action instead:
  // Crispin: https://api.pokemontcg.io/v2/cards/sv7-133
  // Brilliant Blender: https://api.pokemontcg.io/v2/cards/sv8-164
  // Advanced Rule Box / Item / Supporter procedure: https://github.com/FlareZ123/pokemon-sims/blob/main/EN_advanced_manual-2025-transcription-structured.md
