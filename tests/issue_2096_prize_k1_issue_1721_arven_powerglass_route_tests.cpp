// Prize-inspection K1 regression for issue 2096.
...
struct EngineTestAccess {
  ...
  static void establish_k1(Engine& engine) { engine.deck_seen_ = false; engine.prizes_revealed_ = false; engine.prizes_revealed_ = true; }
  static void reset_k0(Engine& engine) { engine.deck_seen_ = false; engine.prizes_revealed_ = false; }
