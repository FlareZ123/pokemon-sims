...
void test_strict_seed_3963_reaches_t4() {
  ...
  // T1 Quick Ball has already established K1. At T4, Treasure can therefore
  ...
  // payload while Crispin attaches the missing Fire to the Active GG VSTAR.
  ...
  // Non-retroactive K1 and dynamic DCI/JIT policy: https://github.com/FlareZ123/pokemon-sims/blob/main/docs/POLICY_DECISIONS.md#k1-after-a-legal-deck-or-prize-inspection https://github.com/FlareZ123/pokemon-sims/blob/main/docs/POLICY_DECISIONS.md#dcijit-treatment https://github.com/FlareZ123/pokemon-sims/blob/main/docs/MODEL_ASSUMPTIONS.md#dci-implementation
  // Confirmed bug: https://github.com/FlareZ123/pokemon-sims/issues/2227
  expect(outcome.first_ready_turn == 4,
         "Strict seed 3963 did not reach readiness on T4.");
...
int main() {
  try {
    test_strict_seed_3963_reaches_t4();
