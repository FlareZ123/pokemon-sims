...
void test_seed_3_uses_t1_treasure_and_reaches_t3() {
  ...
  // and expose the T1 attachment window. Steven then banks the remaining T3 axes.
  ...
  expect(has(trace, "T3 | READY"),
         "issue-2658 seed 3 did not improve strict-JIT readiness to T3");
}
...
int main() {
  try {
    test_seed_3_uses_t1_treasure_and_reaches_t3();
