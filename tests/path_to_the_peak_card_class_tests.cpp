...
void test_registry_metadata_and_intrinsic_classification() {
  ...
  require(definition->canonical_id == "swsh6-148",
          "Path to the Peak canonical print changed.");  // Exact print: https://api.pokemontcg.io/v2/cards/swsh6-148 ; issue: https://github.com/FlareZ123/pokemon-sims/issues/3519
  require(definition->name == "Path to the Peak",
          "Path to the Peak name changed.");
  require(definition->kind == sim::cards::CardKind::Trainer,
          "Path to the Peak must remain a Trainer.");  // Exact card data: https://api.pokemontcg.io/v2/cards/swsh6-148
  require(definition->trainer_kind == sim::cards::TrainerKind::Stadium,
          "Path to the Peak must remain a Stadium.");  // Printed Stadium classification: https://api.pokemontcg.io/v2/cards/swsh6-148 ; Stadium procedure: https://github.com/FlareZ123/pokemon-sims/blob/main/EN_advanced_manual-2025-transcription-structured.md
