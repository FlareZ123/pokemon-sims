...
void test_registry_metadata_and_supporter_classification() {
  ...
  require(definition->canonical_id == "swsh9-148",
          "Roseanne's Backup canonical print changed."); // Exact card data: https://api.pokemontcg.io/v2/cards/swsh9-148
  ...
  require(definition->trainer_kind == sim::cards::TrainerKind::Supporter,
          "Roseanne's Backup must remain a Supporter."); // One-Supporter-per-turn procedure: https://github.com/FlareZ123/pokemon-sims/blob/main/EN_advanced_manual-2025-transcription-structured.md
