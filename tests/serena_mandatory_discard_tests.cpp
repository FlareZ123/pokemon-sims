...
void test_serena_requires_a_discard() {
  ...
  // Serena requires at least one discard before its draw effect: https://api.pokemontcg.io/v2/cards/swsh12-164
...
void test_evolution_incense_is_not_a_hand_payload_discard_route() {
  ...
  // Mysterious Treasure can fetch a Dragon after a hand discard, but Evolution Incense has no discard effect: https://api.pokemontcg.io/v2/cards/sm6-113 https://api.pokemontcg.io/v2/cards/swsh1-163
