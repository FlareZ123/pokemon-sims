...
void test_registry_metadata_and_supporter_classification() {
  ...
  require(definition->canonical_id == "sm7-148",
          "Tate & Liza canonical print changed."); // Exact card data: https://api.pokemontcg.io/v2/cards/sm7-148
  require(definition->name == "Tate & Liza", "Tate & Liza name changed.");
  require(definition->kind == sim::cards::CardKind::Trainer,
          "Tate & Liza must remain a Trainer."); // Trainer identity: https://api.pokemontcg.io/v2/cards/sm7-148
  require(definition->trainer_kind == sim::cards::TrainerKind::Supporter,
          "Tate & Liza must remain a Supporter."); // Printed subtype: https://api.pokemontcg.io/v2/cards/sm7-148 ; Supporter procedure: https://github.com/FlareZ123/pokemon-sims/blob/main/EN_advanced_manual-2025-transcription-structured.md
  ...
  require(!sim::is_item(sim::Card::TateLiza),
          "Tate & Liza must not be classified as an Item."); // Printed Trainer subtype: https://api.pokemontcg.io/v2/cards/sm7-148
