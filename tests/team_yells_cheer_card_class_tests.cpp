...
void test_registry_metadata_and_supporter_classification() {
  ...
  require(definition->kind == sim::cards::CardKind::Trainer,
          "Team Yell's Cheer must remain a Trainer.");  // Trainer identity: https://api.pokemontcg.io/v2/cards/swsh9-149
  require(definition->trainer_kind == sim::cards::TrainerKind::Supporter,
          "Team Yell's Cheer must remain a Supporter.");  // Printed subtype: https://api.pokemontcg.io/v2/cards/swsh9-149 ; procedure: https://github.com/FlareZ123/pokemon-sims/blob/main/EN_advanced_manual-2025-transcription-structured.md
  ...
  require(!sim::is_item(sim::Card::TeamYellsCheer),
          "Team Yell's Cheer must not be classified as an Item.");  // Printed Trainer subtype: https://api.pokemontcg.io/v2/cards/swsh9-149
