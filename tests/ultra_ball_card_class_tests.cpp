...
void test_registry_metadata_and_intrinsic_classification() {
  ...
  require(definition->canonical_id == "sv1-196",
          "Ultra Ball canonical print changed.");  // Exact Scarlet & Violet print: https://api.pokemontcg.io/v2/cards/sv1-196
  require(definition->name == "Ultra Ball", "Ultra Ball name changed.");
  require(definition->kind == sim::cards::CardKind::Trainer,
          "Ultra Ball must remain a Trainer.");  // Exact card data: https://api.pokemontcg.io/v2/cards/sv1-196
  require(definition->trainer_kind == sim::cards::TrainerKind::Item,
          "Ultra Ball must remain an Item.");  // Printed Item classification: https://api.pokemontcg.io/v2/cards/sv1-196 ; Item procedure: https://github.com/FlareZ123/pokemon-sims/blob/main/EN_advanced_manual-2025-transcription-structured.md
